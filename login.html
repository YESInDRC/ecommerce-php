                    ...
                    <div class="col-md-6">    
                        <div class="register-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label>Password</label>
                                    <input class="form-control" name="password" type="password" placeholder="Verify Password">
                                </div>
                                <div class="col-md-6">
                                    <label>Confirm Password</label>
                                    <input class="form-control" name="confirm_password" type="password" placeholder="Mobile No">
                                </div>
                                <div class="col-md-12">
                                    <button class="btn">Submit</button>
                                </div>
